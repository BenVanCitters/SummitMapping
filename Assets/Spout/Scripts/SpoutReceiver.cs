		...
		public Texture2D texture
		{
			...
			set {
				...
				if(GetComponent<Projector>() != null)
				{
					...
					GetComponent<Projector>().material.SetTexture("_ShadowTex", _texture);
					Debug.Log("...GetComponent<Projector>().material.GetTexture(_ShadowTex): " + GetComponent<Projector>().material.GetTexture("_ShadowTex"));
					//GetComponent<Projector>().material.GetTexture("_ShadowTex") = _texture;
